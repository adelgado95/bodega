 ...
 ->setCellValue('C1', 'MARCA')
  ...
  $fecha_inicio = $_REQUEST['fechai'];
      $fecha_fin = $_REQUEST['fechaf'];
          $string = "SELECT Imei,Iccid,Marca,Modelo,Fecha_Entrada,Fecha_Salida,Precio,PrecioTAE,Zona,Departamento,Canal,Encargado,IF(Liquidado=0,'NO_LIQUIDADO','LIQUIDADO') as Liquidado,Estado FROM entradas as e, salida as s where e.IdSalida = s.Id and Fecha_Salida BETWEEN '".$fecha_inicio."' AND '".$fecha_fin."';";
